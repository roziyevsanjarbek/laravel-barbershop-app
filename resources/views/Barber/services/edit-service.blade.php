                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="serviceName" name="serviceName"
                                           placeholder="e.g. Classic Haircut" value="{{ $service->name }}">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" value="{{ $service->price }}" class="form-control" id="servicePrice" name="servicePrice" placeholder="0.00" step="0.01" min="0">
                                    </div>

                                    <!-- Duration -->
                                    <div class="col-md-6 mb-3">
                                        <label for="serviceDuration" class="form-label">Duration (minutes)</label>
                                        <input type="number" class="form-control" id="serviceDuration" value="{{ $service->duration }}" name="serviceDuration" placeholder="30" min="5" step="5">
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body d-flex justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-1"></i> Edit Service
                                </button>
                            </div>
                        </div>
                    </div>
